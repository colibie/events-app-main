...
$(function () {
  ...
  $('body').on('click', '.content-panel-toggler, .content-panel-close, .content-panel-open', function () {
    $('.all-wrapper').toggleClass('content-panel-active');
  });

  // #13. EMAIL APP 

  $('body').on('click', '.more-messages', function () {
    $(this).hide();
  ...
  $('body').on('click', '.ae-list .ae-item', function () {
  ...
  $('body').on('click', '.ae-side-menu-toggler', function () {
    $('.app-email-w').toggleClass('compact-side-menu');
  });

  // EMAIL MOBILE SHOW MESSAGE
  $('body').on('click', '.ae-item', function () {
  ...
  */
  ...
  //         console.log('append', $('.carousel-item').eq(i))
  //       }
  //       else {
